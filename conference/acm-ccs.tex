...
%\begin{equation} \label{eq:hypergeoPMF}
%   \frac{\binom{f_{E}}{k}\binom{N - f_{E}}{L_{Q} - k}}{\binom{N}{L_{Q}}}
%\end{equation}
...
%\begin{equation} \label{eq:compromiseProb}
%   \displaystyle\sum_{x=\ceil{\frac{L_{Q}}{2}}}^{L_{Q}} \frac{\binom{f_{E}}{k}\binom{N - f_{E}}{L_{Q} - k}}{\binom{N}{L_{Q}}}
%\end{equation}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{../analysis/MarkovTransitionDistribution.eps} % todo: replace figure
