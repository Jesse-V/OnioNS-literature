...
\subsubsection{Database Inheritance} % in progress
...
\begin{enumerate} % todo: use triple-equals, \def or something, is there a symbol for XOR?
...
\subsubsection{Record Operations} %todo
\label{sec:recordOps}
...
% todo: mirrors will say "does not exist" but Quorum will not have published the merkle root signature yet
	% need to use temporary "unverifiable" database, which is flushed at end of the Quorum
...
% merkle root signed at end of Quorum
...
\subsubsection{Domain Query} % todo
...
\subsubsection{Onion Query} % todo
