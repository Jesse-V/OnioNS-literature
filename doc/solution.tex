...
\begin{enumerate}
	...
	\item Alice provides a .tor domain name $ d $ into the Tor Browser. The Clearnet has no .tor TLD, so $ d $ is not processed as a traditional domain name would be.
...
Faythe has divided her bitset into $ Q $ sections, digitally signed each section, digitally signed the root hash of the Merkle tree, and send the signatures to Alice.
