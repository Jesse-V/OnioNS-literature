...
%Throughout this section, let Alice be a Tor client, Bob be a hidden service, and Carol be 
...
\begin{enumerate}
	\item Charlie obtains the set of Pages maintained by $ \mathit{Quorum}_{i} $.
	...
	\item For each Page, 
		\begin{enumerate}
			...
			\item Charlie checks that $ \mathit{fingerprint} $ is a member of $ \mathit{Quorum}_{i} $.
...
In this way, Charlie need not preform a deep verification of all Pages from $ \mathit{Quorum}_{i} $ in order to choose a Page.

\subsubsection{Pagechain Validation}

Assume that Charlie has obtained a complete Pagechain. Let him start at the oldest Page and work in chronological order to the most recent Page.
